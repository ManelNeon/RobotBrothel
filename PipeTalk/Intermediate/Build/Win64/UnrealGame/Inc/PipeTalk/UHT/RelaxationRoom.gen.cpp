...
struct Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_RelaxationRoom_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARelaxationRoom, ARelaxationRoom::StaticClass, TEXT("ARelaxationRoom"), &Z_Registration_Info_UClass_ARelaxationRoom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARelaxationRoom), 2470809476U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_RelaxationRoom_h_2447768152(TEXT("/Script/PipeTalk"),
