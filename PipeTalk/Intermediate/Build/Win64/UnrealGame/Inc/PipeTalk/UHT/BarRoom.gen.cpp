...
struct Z_Construct_UClass_ABarRoom_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MoneySound_MetaData[] = {
		{ "Category", "Bar Room Variables" },
		{ "ModuleRelativePath", "BarRoom.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MoneySound;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABarRoom_Statics::NewProp_MoneySound = { "MoneySound", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABarRoom, MoneySound), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MoneySound_MetaData), NewProp_MoneySound_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABarRoom_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABarRoom_Statics::NewProp_MoneySound,
};
...
struct Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_BarRoom_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABarRoom, ABarRoom::StaticClass, TEXT("ABarRoom"), &Z_Registration_Info_UClass_ABarRoom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABarRoom), 1283734661U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_BarRoom_h_2005150473(TEXT("/Script/PipeTalk"),
