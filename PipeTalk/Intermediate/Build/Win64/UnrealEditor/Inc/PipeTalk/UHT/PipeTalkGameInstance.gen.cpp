...
DEFINE_FUNCTION(UPipeTalkGameInstance::execRemoveHostess)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RemoveHostess(Z_Param_id);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UPipeTalkGameInstance_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPipeTalkGameInstance_RemoveHostess, "RemoveHostess" }, // 2009476196
	};
...
struct Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_PipeTalkGameInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPipeTalkGameInstance, UPipeTalkGameInstance::StaticClass, TEXT("UPipeTalkGameInstance"), &Z_Registration_Info_UClass_UPipeTalkGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPipeTalkGameInstance), 3807999373U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDev_UnrealProjects_RobotBrothel_PipeTalk_Source_PipeTalk_PipeTalkGameInstance_h_2681207961(TEXT("/Script/PipeTalk"),
